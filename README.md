...
A guide on how to install Artix  with full disk encryption using LUKS1 with UEFI and BTRFS snapshots with subvolumes. We're also adding some hardening configurations to our volumes and implementing Apparmor.
...
Create two partitions with fdisk one for root and the other for boot and make the boot type efi
